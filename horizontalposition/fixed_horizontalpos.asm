...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    lda #40        ; literal decimal value 40 the start position 
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ...
    cmp #80        ; compare the value on A with literal 80
    bpl ResetXPos  ; if A is greater, then reset position 
                   ; (branch on plus)
    jmp IncrmXPos  ; else, continue to increment position
ResetXPos:
    lda #40        ; load A with literal 40px
    sta P0XPos     ; reset de player X position to 40
IncrmXPos:
    inc P0XPos
