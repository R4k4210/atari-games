...
Start:
    CLEAN_START         ; Macto to safely clear memory and TIA
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;   
    ...
    sta WSYNC           ; first scanline (wait for he TIA)
    sta WSYNC           ; second scanline (wait for he TIA)
    sta WSYNC           ; third scanline (wait for he TIA)
...
LoopVisible:
    stx COLUBK          ; set the background color (using X)
...
LoopOverscan:
    sta WSYNC           ; wait fot he next scanline
    dex                 ; X--
