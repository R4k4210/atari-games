...
;; $80 position is the RAM section, and with ds 1 we say that
;; we want a space of 1 byte in position $80, and the second ds
;; take the space of $81. DS does not initialize the space, and
;; that is one of the reasons why I declared our segment as 
;; uninitialized (seg.u)
;; BYTE is used to put data. We can use either byte or .byte
;; This will add 1 byte of data at a certain address in memory.
;; With .byte we can define a bitmap data. Instead of writing
;; multiple .byte statements per line, we can write several 
;; values separated with comma. Like the smiley face:
;; .byte #$7E,#$FF,#$99,#$FF,#$BD,#$C3,#$FF,#$7E 
;; WORD is used to write data and directly initilize 16bits
;; .word or word are equivalent.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    seg.u Variables
    org $80
P0Height .byte     ; defines one byte for player 0 height. 
                   ; .byte es equivalente a ds 1 o 00000000.
